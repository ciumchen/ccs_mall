<?php /*a:2:{s:63:"/home/wwwroot/default/wstmart/home/view/default/user_login.html";i:1532940744;s:60:"/home/wwwroot/default/wstmart/home/view/default/base_js.html";i:1532940736;}*/ ?>
<html>
<head>
		...
		<input type='hidden' id='typ' value='0' class='ipt'/>
			...
			<div class="wst-item wst-item-box">
				...
				<div class="wst-login-code-1">
					...
					<img id='verifyImg' class="wst-login-codeim-1" src="<?php echo url('home/index/getVerify'); ?>" onclick='javascript:WST.getVerify("#verifyImg")' style="width:125px;height:36px;border-top-right-radius:6px;border-bottom-right-radius:6px;float: left;"><span id="verify"></span>    	
				</div>
			</div>
			...
			<div class="wst-item wst-item-box" style="border: 0;" >
				<div style="width:100%;height:32px;line-height:32px;float:left;"><a class="wst-login-but" href="javascript:void(0);" onclick='javascript:login()'>登录</a></div>
			</div>
