<?php /*a:7:{s:66:"E:\ccswww\testmall/wstmart/home/view\default\shops\goods\edit.html";i:1537276776;s:60:"E:\ccswww\testmall/wstmart/home/view\default\shops\base.html";i:1537276777;s:53:"E:\ccswww\testmall/wstmart/home/view\default\top.html";i:1543113041;s:67:"E:\ccswww\testmall/wstmart/home/view\default\shops\goods\edit0.html";i:1555333694;s:67:"E:\ccswww\testmall/wstmart/home/view\default\shops\goods\edit1.html";i:1537276776;s:67:"E:\ccswww\testmall/wstmart/home/view\default\shops\goods\edit2.html";i:1537276776;s:56:"E:\ccswww\testmall/wstmart/home/view\default\footer.html";i:1539005451;}*/ ?>
<!doctype html>
<head>
			  ...
			  <div class="wst-tag dorpdown-user">
				  ...
				  <div class="wst-tagt-n">
			  	  ...
			  	  <div class="wst-tagb" >
			  		...
			  		<a onclick='WST.position(13,0)' href='<?php echo Url("home/users/index"); ?>'>我的金币</a>
		...
		<ul class="headrf" style='float:right;'>
		    <li class="j-dorpdown" style="width: 86px;">
				<div class="drop-down" style="padding-left:0px;">
					<a href="<?php echo Url('home/users/index'); ?>" target="_blank">我的订单<i class="di-right"></i></a>
				</div>
				<div class='j-dorpdown-layer order-list'>
					<div><a href='<?php echo Url("home/orders/finish"); ?>' onclick='WST.position(3,0)'>已完成订单</a></div>
...
<table class='wst-form'>
  ...
  <tr>
    ...
    <?php if(($object["shopId"]==1)): ?>
    <tr>
        <th>成本价格<font color='red'>*</font>：</th>
        <td><input type='text' class='j-ipt' id='costPrice' value='<?php echo $object["costPrice"]; ?>' maxLength='10' data-rule='成本价格:required;price' data-rule-price="[/^(([0-9]+\.[0-9]*[1-9][0-9]*)|([0-9]*[1-9][0-9]*\.[0-9]+)|([0-9]*[1-9][0-9]*))$/, '价格必须大于0']" onblur="javascript:WST.limitDecimal(this,2)" onkeypress="return WST.isNumberdoteKey(event)" onkeyup="javascript:WST.isChinese(this,1)"/></td>
    </tr>
    <?php endif; ?>
  <tr>
     <th>供货价格<font color='red'>*</font>：</th>
     <td><input type='text' class='j-ipt' id='supplyPrice' value='<?php echo $object["supplyPrice"]; ?>' maxLength='10' data-rule='供货价格:required;price' data-rule-price="[/^(([0-9]+\.[0-9]*[1-9][0-9]*)|([0-9]*[1-9][0-9]*\.[0-9]+)|([0-9]*[1-9][0-9]*))$/, '价格必须大于0']" onblur="javascript:WST.limitDecimal(this,2)" onkeypress="return WST.isNumberdoteKey(event)" onkeyup="javascript:WST.isChinese(this,1)"/></td>
  </tr>
  <tr>
  ...
  <tr>
      <th>商品税率<font color='red'>*</font>：</th>
        <td>
          <select id='goodsRate' class='j-ipt'>
            <option value='0' <?php if(($object["goodsRate"]==0)): ?>selected<?php endif; ?>>0%/普票</option>
            <option value='1' <?php if(($object["goodsRate"]==1)): ?>selected<?php endif; ?>>专票3%</option>
            <option value='2' <?php if(($object["goodsRate"]==2)): ?>selected<?php endif; ?>>专票10%</option>
            <option value='3' style="display:none" <?php if(($object["goodsRate"]==3)): ?>selected<?php endif; ?>>专票16%</option>
          </select>
        </td>
  </tr>
  ...
  <tr>
     ...
     <td colspan='2'>
      <div class="checkbox-box">
        ...
        <label>
	        <input id="isDouble" name="isDouble" class="j-ipt wst-checkbox" <?php if($object['isDouble']==1): ?>checked<?php endif; ?> value="1" type="checkbox"/><label class="mt-1" for="isDouble"></label>双倍积分
	      </label>
        <label>
          <input id="isGlobal" name="isGlobal" class="j-ipt wst-checkbox" <?php if($object['isGlobal']==1): ?>checked<?php endif; ?> value="1" type="checkbox"/><label class="mt-1" for="isGlobal"></label>全球代购
        </label>
        <?php if(($object["shopId"]==1)): ?>
        <label>
          <input id="isTrain" name="isTrain" class="j-ipt wst-checkbox" <?php if($object['isTrain']==1): ?>checked<?php endif; ?> value="1" type="checkbox"/><label class="mt-1" for="isTrain"></label>V3直通车
        </label>
        <?php endif; ?>
      </div>     
     </td>
