<?php /*a:4:{s:71:"E:\ccswww\testmall/wstmart/home/view\default\shops\goods\list_sale.html";i:1542117176;s:60:"E:\ccswww\testmall/wstmart/home/view\default\shops\base.html";i:1537276777;s:53:"E:\ccswww\testmall/wstmart/home/view\default\top.html";i:1543113041;s:56:"E:\ccswww\testmall/wstmart/home/view\default\footer.html";i:1539005451;}*/ ?>
<!doctype html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<title>出售中的商品-卖家中心<?php echo WSTConf('CONF.mallTitle'); ?></title>
...
<div class="wst-shop-tbar">
  ...
  <label>
    商品名称：<input type="text" name="goodsName" id="goodsName" class="s-query" /><a class="s-btn" onclick="saleByPage()">查询</a>
  </label>
</div>
<div class="wst-shop-content"> 
   <div class="s-menu">
      ...
      <a href='javascript:void(0);' onclick="changeGoodsStatus('isDouble','sale')" class="s-double"><span>双倍积分</span></a>
      <a href='javascript:void(0);' onclick="changeGoodsStatus('isTrain','sale')" class="s-train"><span>V3直通车</span></a>
   ...
   <tr>
      ...
      <td><div status="{{d[i]['isDouble']}}" title='双击可修改' ondblclick='changSaleStatus("d",this,{{d[i]["goodsId"]}})' class="w-r {{((d[i]['isDouble']==1)?'right':'wrong')}}"></div></td>
      <td><div status="{{d[i]['isTrain']}}" title='双击可修改' ondblclick='changSaleStatus("t",this,{{d[i]["goodsId"]}})' class="w-r {{((d[i]['isTrain']==1)?'right':'wrong')}}"></div></td>
