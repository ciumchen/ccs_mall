<?php /*a:2:{s:71:"/home/wwwroot/default/wstmart/admin/view/wxpassivereplys/subscribe.html";i:1532936920;s:50:"/home/wwwroot/default/wstmart/admin/view/base.html";i:1532939608;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<?php if(WSTGrant('WX_WBXX_01')): ?>
<div class="wst-toolbar">
   <font color='red'>(为避免造成骚扰，系统最多只取10条记录进行推送)</font>
   <button class="btn btn-success f-right" onclick="javascript:editBox({id:0,content:''})"><i class='fa fa-plus'></i>新增</button>
   <button class="btn btn-success f-right" onclick="javascript:openResource()" style='margin-right:10px;'><i class='fa fa-suitcase'></i>主动回复素材</button>
...
<script src="__ADMIN__/wxpassivereplys/subscribe.js?v=<?php echo $v; ?>" type="text/javascript"></script>
