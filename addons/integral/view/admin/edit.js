	...
	$.post(WST.AU("integral://shops/searchGoods"),params,function(data,textStatus){
	    ...
	    if(json.status==1 && json.data){
	    	...
	    	for(var i=0;i<json.data.length;i++){
                ...
                html.push('<option value="'+json.data[i].goodsId+'" gt="'+json.data[i].goodsType+'" mp="'+json.data[i].marketPrice+'" sp="'+json.data[i].shopPrice+'">'+json.data[i].goodsName+'</option>');
	    	}
